...
/**
 * Created by xianshajin on 11/24/17.
 */
...
public class ViewControlLayer extends CameraControlLayer {
    ...
    public ViewControlLayer(final Context context, final ExecutorService executorService, final RosImageView<CompressedImage> cameraView, final VisualizationView mapView, final ViewGroup mainLayout, final ViewGroup sideLayout, final AppParameters params) {
               ...
               rotateGestureDetector = new RotateGestureDetector(new RotateGestureDetector.OnRotateGestureListener() {
                   ...
                   public boolean onRotate(MotionEvent event1, MotionEvent event2, final double deltaAngle) {
                       if (mapViewGestureAvailable) {
                           ...
                           // Don't consume this event in order to allow the zoom gesture to also be detected.
                           return false;
                       }
                       return true;
                   }
