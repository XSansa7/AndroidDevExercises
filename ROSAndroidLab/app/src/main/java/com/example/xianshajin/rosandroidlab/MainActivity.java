...
public class MainActivity extends RosAppActivity {
    ...
    protected void init(NodeMainExecutor nodeMainExecutor) {
        ...
        ViewControlLayer viewControlLayer = new ViewControlLayer(this, nodeMainExecutor.getScheduledExecutorService(), cameraView, mapView, mainLayout, sideLayout, params);
        ...
        viewControlLayer.addListener(new CameraControlListener() {
            ...
            @Override
            public void onRotate(float v, float v1, double v2) {

            }

            @Override
            public void onZoom(float v, float v1, float v2) {
        ...
        // NTP synchronized wallclock (actual) time vs wallclock time
        try {
            NtpTimeProvider ntpTimeProvider = new NtpTimeProvider(InetAddressFactory.newFromHostString("pool.ntp.org"), nodeMainExecutor.getScheduledExecutorService());
